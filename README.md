...
The multi-input Jupyter notebook combines image data with tabular features.
  ...
  The pretrained image recognition notebook compares Transformer-based models and CNN architectures.
  In addition, we use a weighted loss function to address class imbalance.

  The Transformer appears to be significantly more flexible when classifying the images without extensive transfer learning, compared to the CNN.
